...
const ContactListRange = (props) => {
  ...
  const inputChangedHandler = (event, inputIdentifier) => {
    ...
    const updatedQuickSMSForm = { ...formState.contactListRangeForm };
    ...
    console.log(updatedQuickSMSForm[inputIdentifier]);
    setFormState({ contactListRangeForm: updatedQuickSMSForm });
  ...
  let dialog = formState.alertOpen ? (
    <AlertDialog
  ...
  let scheduleForm =
    formState.contactListRangeForm["sms_schedule"].value === "yes" ? (
      <Row>
        <Col>
  ...
  return (
    <React.Fragment>
      ...
      <Container fluid className="p-0">
        <h1 className="h3 mb-3">Contact List (Range)</h1>

        <Card>
          <Card.Header>
            <Card.Title tag="h5">
              Send SMS to a selected range in your contact list
            </Card.Title>
          ...
          <Card.Body>
            <Form onSubmit={sendSMSHandler}>
              ...
              <Row>
                <Col md={6}>
                  <Form.Group className="mb-3">
                    <Form.Label>Start List count</Form.Label>
                    <Form.Control
                      onChange={(event) =>
                        inputChangedHandler(event, "contact_list_start")
                      }
                      type="text"
                      name="startListCount"
                      placeholder="Start List count"
                    />
                  </Form.Group>
                </Col>
                <Col md={6}>
                  <Form.Group className="mb-3">
                    <Form.Label>
                      End List count<strong>Total records: 5</strong>
                    </Form.Label>
                    <Form.Control
                      onChange={(event) =>
                        inputChangedHandler(event, "contact_list_end")
                      }
                      type="text"
                      name="endListCount"
                      placeholder="End List count"
                    />
                  </Form.Group>
                </Col>
              </Row>
...
export default ContactListRange;
